...
export default function Contact() {
  ...
  return (<>
    <div className="flex flex-col justify-center min-h-[100vh] w-[100%] h-[100%] m-0% items-center bg-[#000000]">
        <div>
        <div ><h1 className='text-[white]'>You can post your queries here</h1></div>
        
            
        <div><label className='mt-[10px] text-[white] '>Enter email  </label></div>
        ...
        <div> <label className='mt-5 text-[white] ' >Enter your query</label> </div>
        ...
        <div><input className='text-[white]' type="submit" onClick={add_data}/></div>
        <div>
        <ul>
            {list.map((input)=>(
